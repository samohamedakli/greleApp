...
export class CultureComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.cultureService
            ...
            .subscribe(
                (res: HttpResponse<ICulture[]>) => this.paginateCultures(res.body, res.headers),
    ...
    registerChangeInCultures() {
        this.eventSubscriber = this.eventManager.subscribe('cultureListModification', response => this.reset());
    }
    ...
    protected paginateCultures(data: ICulture[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        for (let i = 0; i < data.length; i++) {
            this.cultures.push(data[i]);
        }
    }
